...
@Component({
  selector: 'app-osatletacouch',
  templateUrl: './osatletacouch.component.html',
  styleUrls: ['./osatletacouch.component.css']
})
export class OsatletacouchComponent implements OnInit {
