...
@Component({
  selector: 'app-tcatletacouch',
  templateUrl: './tcatletacouch.component.html',
  styleUrls: ['./tcatletacouch.component.css']
})
export class TcatletacouchComponent implements OnInit {
